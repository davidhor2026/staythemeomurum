window.SITE_UPDATES = {
  ...
  pages: {
    ...
    'exam-insight.html': { key: 'examInsight', updated: '2026-09-06', expires: '2026-09-13' },
    ...
    'rent-support.html': { key: 'rentSupport', updated: '2026-09-19', expires: '2026-09-26' },
...
(function () {
  ...
  function addStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      ".stay-scroll-cue{position:fixed;left:50%;bottom:max(18px,calc(env(safe-area-inset-bottom) + 12px));z-index:40;display:flex;min-width:92px;flex-direction:column;align-items:center;justify-content:center;gap:1px;padding:7px 14px 6px;border:1px solid rgba(21,63,37,.15);border-radius:999px;background:rgba(255,255,255,.82);box-shadow:0 5px 18px rgba(18,45,28,.11);color:#153f25;font-family:inherit;opacity:0;visibility:hidden;transform:translate(-50%,10px);transition:opacity .22s ease,transform .22s ease,visibility 0s linear .22s;pointer-events:none;user-select:none;-webkit-user-select:none;backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px)}",
      ".stay-scroll-cue.is-visible{opacity:.88;visibility:visible;transform:translate(-50%,0);transition-delay:0s}",
